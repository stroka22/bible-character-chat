  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.background }}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity onPress={() => nav.navigate('ChatNew', { preselectedCharacterId: item.id })} style={{ width: 210, paddingVertical: 8, paddingHorizontal: 10, borderRadius: 12, backgroundColor: theme.colors.card, marginHorizontal: 4 }}>
            ...
            {item.description ? <Text numberOfLines={1} style={{ color: theme.colors.muted, marginTop: 4 }}>{item.description}</Text> : null}
          </TouchableOpacity>
        )}
