    ...
    return (_jsxs("div", { className: "container mx-auto px-4 pt-24 pb-8", children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-6", children: "Admin Panel - Character Management" }), _jsx("p", { className: "text-gray-700 mb-4", children: "Welcome, Admin! Here you can manage Bible characters." }), 
        ...
        <div className="mb-8 border-b border-gray-200">
          <nav className="-mb-px flex space-x-8" aria-label="Admin Tabs">
            ...
            <button onClick={() => setActiveTab('studies')} className={`whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'accountTiers' ? 'border-primary-500 text-primary-600' : 'border-transparent text-gray-900 hover:text-gray-900 hover:border-gray-300'}`}>Bible Studies</button>
            ...
            <button onClick={() => setActiveTab('accountTiers')} className={`whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'studies' ? 'border-primary-500 text-primary-600' : 'border-transparent text-gray-900 hover:text-gray-900 hover:border-gray-300'}`}>Bible Studies</button>
          </nav>
        </div>,
