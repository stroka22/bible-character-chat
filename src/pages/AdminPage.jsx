...
const AdminPage = () => {
    ...
    return (_jsxs("div", { className: "container mx-auto px-4 pt-24 pb-8 md:pl-72", children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-2", children: "Admin Panel - Character Management" }), _jsx("p", { className: "text-gray-700 mb-4", children: "Welcome, Admin! Here you can manage Bible characters." }), 
        _jsx("div", { className: "hidden md:block", children: _jsxs("aside", { className: "fixed top-24 left-6 w-64 bg-white rounded-md shadow border", children: [_jsx("div", { className: "px-4 py-3 text-xs font-semibold text-gray-500 uppercase", children: "Navigation" }), _jsxs("nav", { className: "px-2 pb-3 space-y-1", children: [_jsx("button", { onClick: () => setActiveTab('overview'), className: `w-full text-left px-3 py-2 rounded ${activeTab === 'overview' ? 'bg-gray-200' : 'hover:bg-gray-100'}`, children: "Overview" }), _jsx("button", { onClick: () => setActiveTab('characters'), className: `w-full text-left px-3 py-2 rounded ${activeTab === 'characters' ? 'bg-gray-200' : 'hover:bg-gray-100'}`, children: "Characters" }), _jsx("button", { onClick: () => setActiveTab('groups'), className: `w-full text-left px-3 py-2 rounded ${activeTab === 'groups' ? 'bg-gray-200' : 'hover:bg-gray-100'}`, children: "Groups" }), _jsx("button", { onClick: () => setActiveTab('featured'), className: `w-full text-left px-3 py-2 rounded ${activeTab === 'featured' ? 'bg-gray-200' : 'hover:bg-gray-100'}`, children: "Featured Character" }), _jsx("button", { onClick: () => setActiveTab('studies'), className: `w-full text-left px-3 py-2 rounded ${activeTab === 'studies' ? 'bg-gray-200' : 'hover:bg-gray-100'}`, children: "Bible Studies" }), _jsx(Link, { to: "/admin/premium", className: "block px-3 py-2 rounded hover:bg-gray-100", children: "Premium Members" }), _jsx("button", { onClick: () => setActiveTab('faq'), className: `w-full text-left px-3 py-2 rounded ${activeTab === 'faq' ? 'bg-gray-200' : 'hover:bg-gray-100'}`, children: "FAQ" })] }), isSuperadmin() && (_jsxs(_Fragment, { children: [_jsx("div", { className: "px-4 pt-3 text-xs font-semibold text-gray-500 uppercase", children: "Advanced" }), _jsxs("nav", { className: "px-2 pb-3 space-y-1", children: [_jsx("button", { onClick: () => setActiveTab('roundtable'), className: `w-full text-left px-3 py-2 rounded ${activeTab === 'roundtable' ? 'bg-gray-200' : 'hover:bg-gray-100'}`, children: "Roundtable" }), _jsx("button", { onClick: () => setActiveTab('accountTiers'), className: `w-full text-left px-3 py-2 rounded ${activeTab === 'accountTiers' ? 'bg-gray-200' : 'hover:bg-gray-100'}`, children: "Account Tiers" }), _jsx(Link, { to: "/admin/users", className: "block px-3 py-2 rounded hover:bg-gray-100", children: "Users & Organizations" })] })] }))] }) }), 
