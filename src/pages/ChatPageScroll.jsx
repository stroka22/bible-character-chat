                  ...
                  <div className="absolute right-0 top-full mt-1 bg-white rounded-lg shadow-lg border border-amber-200 py-1 z-50 min-w-[160px]">
                    ...
                    <button
                      ...
                      className={`w-full px-4 py-2 text-left flex items-center gap-2 text-sm ${
                        isPremium ? 'text-amber-800 hover:bg-amber-50' : 'text-gray-400 hover:bg-gray-50'
                      }`}
                    >
          ...
          <div className="hidden sm:flex items-center gap-1">
            ...
            {messages.length > 0 && (
              <button
                ...
                title={isPremium ? "Invite to chat" : "Premium feature"}
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                </svg>
            ...
            {messages.length > 0 && (
              <button
                ...
                title={isPremium ? "Share conversation" : "Premium feature"}
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" />
                </svg>
            ...
            {messages.length > 0 && (
              <button
                ...
                title={isPremium ? "Copy transcript" : "Premium feature"}
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                </svg>
