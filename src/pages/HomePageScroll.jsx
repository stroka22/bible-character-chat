...
const HomePageScroll = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-orange-50 to-amber-100">
      ...
      <section className="relative z-10 pt-28 pb-12 px-4 md:px-8">
          ...
          <ScrollWrap>
            <div className="text-center">
              ...
              <p className="text-sm md:text-base text-amber-800/80 max-w-md mx-auto mb-4">
                Engage in meaningful conversations with Biblical characters and explore the timeless truths they embody.
              </p>
