...
var AdminPage = function () {
    ...
    var isAdmin = user && user.email === 'admin@example.com';
    if (!isAdmin) {
...
function App() {
    ...
    return (_jsx(BrowserRouter, { children: _jsx(AuthProvider, { children: _jsx(ChatProvider, { children: _jsx("div", { className: "flex min-h-screen flex-col bg-gray-50", children: _jsx("main", { className: "flex-grow", children: _jsx(Routes, { children: _jsx(Route, { path: "/*", element: _jsx(MainContent, {}) }) }) }) }) }) }) }));
}
export default App;
